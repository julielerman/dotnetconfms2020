...
namespace Data
{
    public class TeamContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ManagerTeamHistory>()
                .HasKey(m => new { m.ManagerId, m.TeamId });
        ...
        public override int SaveChanges()
        {
            ...
            var entries = ChangeTracker.Entries()
                .Where(e => e.Entity is Team && (e.State == EntityState.Added || e.State == EntityState.Modified));
